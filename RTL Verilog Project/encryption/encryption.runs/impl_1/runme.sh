...
HD_PWD='C:/Users/User/OneDrive/Desktop/EEE6225/encryption/encryption.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log encryption_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source encryption_top.tcl -notrace
