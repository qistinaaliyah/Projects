...
HD_PWD='C:/Users/User/OneDrive/Desktop/EEE6225/encryption/encryption.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log encryption_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source encryption_top.tcl
