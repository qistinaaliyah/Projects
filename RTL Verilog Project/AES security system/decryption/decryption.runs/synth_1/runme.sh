...
HD_PWD='C:/Users/User/OneDrive/Desktop/EEE6225/decryption/decryption.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decryption_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decryption_top.tcl
