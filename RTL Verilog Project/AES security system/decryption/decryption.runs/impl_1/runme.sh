...
HD_PWD='C:/Users/User/OneDrive/Desktop/EEE6225/decryption/decryption.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log decryption_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source decryption_top.tcl -notrace
